  ...
  function ThreeBSP(treeIsh, matrix1, options) {
    ...
    if ((base = this.options).timer == null) {
      base.timer = new Timelimit(
        (ref = (ref1 = this.options.timer) != null ? ref1.timeout : void 0) != null
          ? ref
          : this.options.timeout,
        (ref2 = (ref3 = this.options.timer) != null ? ref3.progress : void 0) != null
          ? ref2
            ...
            for (k = 0, len = ref.length; k < len; k++) {
              ...
              results.push(
                _this.options.timer.doTask(function () {
                  ...
                  results1 = []
                  for (
                    idx = l = 2, ref1 = polyVerts.length;
                    2 <= ref1 ? l < ref1 : l > ref1;
                    idx = 2 <= ref1 ? ++l : --l
                  ) {
        ...
        return function () {
          ...
          _this.options.timer.doTask(function () {
            ...
            for (k = 0, len = polygons.length; k < len; k++) {
              ...
              results.push(
                _this.options.timer.doTask(function () {
                  return _this.divider.subdivide(
                    poly,
                    _this.polygons,
                    _this.polygons,
                    sides.front,
